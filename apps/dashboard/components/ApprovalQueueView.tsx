        ...
        <div className="grid grid-cols-1 gap-4">
          {approvals.map((approval) => (
            <div
              ...
              className="p-4 rounded-lg border border-border bg-card/60 hover:border-accent/40 cursor-pointer flex flex-col md:flex-row md:items-start justify-between gap-5 relative overflow-hidden group"
            >
...
function ApprovalGateIcon() {
  return (
    <svg className="w-48 h-32 mx-auto mb-4" viewBox="0 0 150 95.6" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <style type="text/css">{`
          .cls-0 { fill: #21242C; }
        ...
        `}</style>
        <linearGradient id="SVGID_1_" x1="48.11" x2="97.64" y1="-23.21" y2="68.9" gradientTransform="matrix(1 0 0 -1 0 68)" gradientUnits="userSpaceOnUse">
          <stop stopColor="#15161B" offset="0"/>
          <stop stopColor="#1B1E25" offset="1"/>
        </linearGradient>
        <linearGradient id="SVGID_2_" x1="7.1" x2="143.1" y1="3.831" y2="3.831" gradientTransform="matrix(1 0 0 -1 0 68)" gradientUnits="userSpaceOnUse">
          <stop stopColor="#464A55" offset="0"/>
          <stop stopColor="#585E69" offset="1"/>
        </linearGradient>
        <radialGradient id="SVGID_3_" cx="-276.1" cy="768.4" r="17.99" gradientTransform="matrix(-1 0 0 .85 -199.3 -628)" gradientUnits="userSpaceOnUse">
          <stop stopColor="#DA7A39" offset="0"/>
          <stop stopColor="#FD841F" stopOpacity="0" offset="1"/>
        </radialGradient>
        <linearGradient id="SVGID_4_" x1="50.89" x2="100.1" y1="27.09" y2="27.09" gradientTransform="matrix(1 0 0 -1 0 68)" gradientUnits="userSpaceOnUse">
          <stop stopColor="#FD841F" stopOpacity=".5" offset="0"/>
          <stop stopColor="#FEA047" stopOpacity=".2" offset="1"/>
        </linearGradient>
        <linearGradient id="SVGID_5_" x1="59.78" x2="78.73" y1="21.85" y2="21.85" gradientTransform="matrix(1 0 0 -1 0 68)" gradientUnits="userSpaceOnUse">
          <stop stopColor="#151720" offset="0"/>
          <stop stopColor="#15161B" stopOpacity=".2" offset="1"/>
        </linearGradient>
      </defs>
      <path className="cls-1" d="m143 37-0.1 4c0 0.6-0.4 1-0.9 1.2l-78.9 45.2c-1.1 0.6-2.4 0.6-3.4 0l-51.9-29-0.7-0.5v-4.4l81-46.1c1.1-0.5 2.5-0.4 3.5 0.1l50.4 28.3c0.6 0.2 1 0.8 1 1.2z"/>
      <path className="cls-2" d="m62.6 87.6v-4.6h-3.4v4c1 0.6 2.4 0.9 3.4 0.6z"/>
      <path className="cls-3" d="m142.1 37.9-79.2 44.9c-1.1 0.6-2.4 0.6-3.5 0.1l-51.6-28.5c-1-0.5-1-1.6 0-2.1l80.2-45.1c1.1-0.5 2.4-0.5 3.5 0.1l50.5 28.6c1.2 0.5 1.2 1.5 0.1 2z"/>
      <path className="cls-4" d="m44.9 76.1-22.1-12.5 61.3-36.3 22.3 13.4"/>
      <path className="cls-5" d="m62.9 82.8c-1.1 0.6-2.4 0.6-3.5 0.1l-51.6-28.5c-0.5-0.2-0.7-0.6-0.7-0.9s0.3 0.6 0.7 0.8l13 7.2c0.7 0.5 1.6 0.7 2.4 0.5l62.9-35.1 20.5 12.7 0.7 0.3 0.7 0.1-62.8 34.2v2.3l-22.4-12.9v0.2l36.7 22.1c1.1 0.5 2.4 0 3.2-0.3l79.4-47.1c0.5-0.3 0.9-0.9 0.9-1.2l-80.1 45.5z"/>
      <path className="cls-6 animated-belt" d="m16.9 47.2 16 9m-15.7-9.1 15.7 9.1"/>
      <path className="cls-4" d="m25 42.5 16.1 9.1m-16.5 0.2 23.3-13.1m-7.9-4.3 16.2 8.8m5.6-21.7 21.9 12.1m-15.3-16.1 16.6 8.4m-10.2-11.5 19.6 6.1m-8.2-4.5 4.9 3.3 2.7-0.9 2.8 0.9 8.5-4.5m9.5 21 8 4.2c0.2 0.1 0.2 0.5 0 0.6l-9.1 5.3-8.8-4.8"/>
      <path className="cls-4" d="m40.4 42.8 8.5 4.5m19-30.4 9.3 4.7-7 4.1 7.5 4.1"/>
      <path className="cls-6 animated-belt" d="m112.9 36.6 15.9 9"/>
      <path className="cls-4" d="m132.3 29.9-1.1 0.9-1 3.4-9.6 5.1"/>
      <path className="cls-6 animated-belt" d="m45.2 74.6 14.1 8c0.9 0.7 2.7 0.8 3.8 0.4l78.9-45c0.8-0.4 1-0.8 1-1.1"/>
      <path className="cls-4" d="m55.8 68.4 2.6 1.5-0.8 0.3-4.7-0.3"/>
      <path className="cls-4" d="m63.9 63.9 15.1 8.9m-14.9 0.5 15.8-8.9-8.6-4.5m0 8.6 15.5-8.2-8.1-4.6"/>
      <path className="cls-4" d="m80.1 64.4 6.8 3.9m-6.9-7.9 14.3-4.4-7.9-4.4"/>
      <polyline className="cls-4" points="87.2 60.3 94.6 64.3 102.1 60.2 94.8 56"/>
      <path className="cls-17 animated-shadow" d="m69.1 53.9 10-6.3c0.5-0.2 0.4-1.3-0.7-1.8-0.9-0.5-9.4 4.8-10.4 4.8-0.9 0-6.5-2.8-7-3.2-1-0.6-1.9 0.8-1.1 1.9l6.9 4.2c0.6 0.4 1.6 0.8 2.3 0.4z"/>
      <g className="animated-floating-gate">
        <path className="cls-7" d="m66.1 8.8 0.1 28.8 19.9 10.9c8.1-5.4 8.4-5.2 5.6-7.2v-24.6l-20.5-9.7-5.1 1.8z"/>
        <path className="cls-8" d="m69.9 9.8-3.6 2 23.5 9.8 0.1 27.8 1.9-0.8v-28.3z"/>
        <path className="cls-9" d="m66.3 11.8v27.6l2.7-1.5v-23.6l16.5 9.9v27.9l3.3-1.8 1-28.7z"/>
        <path className="cls-10" d="m66.4 11.9 20.5 11.2v28.4"/>
        <path className="cls-11" d="m69.1 40.7h4.2l5.1 2.9c0.7 0.4 0.6 1 0.1 1.2l-9.4 5.5c-0.6 0.3-1.7 0.3-2.3 0l-6.1-3.4c-0.4-0.1-0.4-0.9 0-1.1l8.4-5.1z"/>
        <path className="cls-13" d="m69.1 40.7 4.1-0.1 5.3 3c0.5 0.3 0.5 0.8-0.1 1.1l-9.3 5.2c-0.5 0.7-1.5 0.1-2 0l-6.3-3c-0.4-0.3-0.4-1 0-1.2l8.3-5z"/>
        <path className="cls-14" d="m66.1 37.6-43.3 24.5v1.6l61.2-27.5v-7.7l1.5 0.8v-1.3l-1.5-0.8z"/>
        ...
        <path d="m71.1 9.2-2.1 1.2 20.9 11.2v26.3l1.8 0.9 0.1-28.5z" fill="#FC8928" opacity=".4"/>
      </g>
    </svg>
  );
}

...
export type MCPServerConfig =
  z.infer<
    typeof MCPServerConfigSchema
  >;

export const DiscoveredToolSchema =
  z.object({
    name: z.string(),
...
export type DiscoveredTool =
  z.infer<
    typeof DiscoveredToolSchema
  >;

export const ToolExecutionRequestSchema =
  z.object({
    toolName: z.string(),
...
export const ToolExecutionResponseSchema =
  z.object({
    success: z.boolean(),
